...
class Distribution(object):
    ...
    def __init__(self, id=None, percent=None, bitmap=None, variant_key=None, variant_id=None):  # noqa: E501
    ...
    @property
    def bitmap(self):
        """Gets the bitmap of this Distribution.  # noqa: E501


        :return: The bitmap of this Distribution.  # noqa: E501
        :rtype: str
        """
        return self._bitmap
    ...
    def bitmap(self, bitmap):
        """Sets the bitmap of this Distribution.


        :param bitmap: The bitmap of this Distribution.  # noqa: E501
        :type: str
        """
        if bitmap is not None and len(bitmap) < 1:
            raise ValueError("Invalid value for `bitmap`, length must be greater than or equal to `1`")  # noqa: E501
