...
class EvalResult(object):
    ...
    def __init__(self, flag_id=None, flag_snapshot_id=None, segment_id=None, variant_id=None, variant_key=None, variant_attachment=None, eval_context=None, timestamp=None, eval_debug_log=None):  # noqa: E501
